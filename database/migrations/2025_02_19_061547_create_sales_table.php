...
class CreateSalesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sales', function (Blueprint $table) {
            ...
            $table->enum('tipo',['0','1','2','3','4','5', '6', '7'])->default('0'); // 0 = POS-Mostrador, 1 =  Domicilio, 2 = Parrilla - Mostrador - para EN EL LOCAL,  3 = Parrilla - Domicilio - PARA LLEVAR A CASA 
                        // Autoservicio 4 = Domicilio, 5 = Pos
