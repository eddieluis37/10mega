		...
		<div class="widget widget-chart-one">
			<div class="widget-heading">
				...
				<ul class="tabs tab-pills">
					<li>
						<a href="javascript:void(0)" onclick="window.location.href = '../../promotions'" class="tabmenu bg-dark" data-toggle="modal" data-target="" title="Regresa al listado">Volver</a>
					</li>
				</ul>
			</div>
								...
								<div class="col-md-10">
									<div class="task-header">
										<div class="form-group">
											...
											<input type="hidden" id="centrocosto" name="centrocosto" value="{{ $datacompensado[0]->status }}">
											<input type="hidden" id="cliente" name="cliente" value="{{ $datacompensado[0]->status }}">
											<input type="hidden" id="porc_descuento_cliente" name="porc_descuento_cliente" value="{{ $datacompensado[0]->status }}">
					...
					<table id="tableDespostere" class="table table-sm table-striped table-bordered">
						<thead class="text-white" style="background: #3B3F5C">
							<tr>
								...
								<th class="table-th text-white">Des</th>
								<th class="table-th text-white">{{$datacompensado[0]->status}}%DCl</th>
