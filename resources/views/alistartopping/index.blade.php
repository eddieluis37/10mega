				...
				<fieldset id="contentDisable">
					<form action="" id="form-alistamiento">
						<div class="modal-header">
							<h4 class="modal-title">Alistar topping</h4>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span></button>
						</div>
				 		<div class="modal-body">
							@include('alistartopping.modal_create')
						</div>
...
@endsection
@section('script')
<script src="{{asset('rogercode/js/alistartopping/rogercode-index.js')}}"></script>
<script src="{{asset('rogercode/js/alistartopping/rogercode-create-update.js')}}" type="module"></script>
@endsection