...
<div class="sidebar-wrapper sidebar-theme">
    <nav id="compactSidebar">
        <ul class="menu-categories">
            ...
            @can('Pos_Create')
            <li class="">
                <a href="{{ url('https://trazaqa.carnesfriasmega.co/') }}" class="menu-toggle" data-active="false">
                    <div class="base-menu">
                        <div class="base-icons">
        ...
        <div class=" submenu" id="products">
            <ul class="submenu-list" data-parent-element="#products">
              ...
              <!--   <li>
                ...
                <li>
                    <a href="{{ url('promotions') }}"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle">
                                <circle cx="12" cy="12" r="10"></circle>
