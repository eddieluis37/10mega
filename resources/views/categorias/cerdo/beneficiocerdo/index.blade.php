...
<div class="row sales layout-top-spacing">
	<div class="col-sm-12">
		<div class="widget widget-chart-one">
			<div class="widget-heading">
				<h4 class="card-title">
					<b>Beneficio Cerdo | Listado </b>
				</h4>
				<ul class="tabs tab-pills">
					<li>
						<a href="javascript:void(0)" onclick="showModalcreate()" class="tabmenu bg-dark" data-toggle="modal" data-target="#modal-create-beneficiocerdo" title="Nuevo Beneficio">Agregar</a>
					</li>
				</ul>
			</div>
			...
			<div class="widget-content">
				<div class="table-responsive">
					<table id="tableBeneficiocerdos" class="table table-striped mt-1">
	...
	<!-- modal -->
	<div class="modal fade" id="modal-create-beneficiocerdo" aria-hidden="true" data-keyboard="false" data-backdrop="static" >
		<div class="modal-dialog modal-xl" role="document">
			<div class="modal-content bg-default">
				<fieldset id="contentDisable">
					<form action="" id="form-beneficiocerdos-cerdos">
						<div class="modal-header">
				 		...
				 		<div class="modal-body">
							@include('categorias.cerdo.beneficiocerdo.modal_create')
						</div>
