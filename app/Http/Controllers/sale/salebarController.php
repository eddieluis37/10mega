...
class salebarController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sale_bar.index', compact('ventas', 'direccion', 'centros', 'defaultCentro', 'clientes', 'vendedores', 'domiciliarios', 'subcentrodecostos'));
    }
    ...
    public function showBar()
    {
        ...
        return Datatables::of($data)->addIndexColumn()
            ...
            ->addColumn('action', function ($data) {
                ...
                if ($data->status == 0) {
                    $btn .= '<a href="sale_bar/create/' . $data->id . '" class="btn btn-dark" title="Detalles">
    ...
    public function create_bar($id)
    {
        ...
        return view('sale_bar.create', compact('datacompensado', 'results', 'id', 'detalleVenta', 'ventasdetalle', 'arrayTotales', 'status', 'statusInventory', 'display'));
    }
    ...
    public function store_bar(Request $request) // Guardar venta bar por domicilio
    {
        try {
            $rules = [
                'ventaId' => 'required',
    ...
    public function storeBarMostrador(Request $request) // Bar-Mostrador
    {
        //   $centros = Centrocosto::WhereIn('id', [1])->get();
        // Obtiene los IDs de los centros de costo asociados a las tiendas del usuario autenticado.
        $centroIds = Auth::user()->stores->pluck('centrocosto_id')->unique();
