...
class saleautoservicioController extends Controller
{
    ...
    public function create_autoservicio($id)
    {
        ...
        return view('sale_autoservicio.create', compact('venta', 'datacompensado', 'results', 'id', 'detalleVenta', 'ventasdetalle', 'arrayTotales', 'status', 'statusInventory', 'display'));
    }
     ...
     *
     * Recibe:
     * - q: término de búsqueda (nombre, código o EAN-13)
     * - sale_id: ID de la venta en curso
     */
