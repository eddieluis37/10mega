...
class SaleDetail extends Model
{
    ...
    protected $fillable = ['sale_id','store_id','product_id','lote_id','price','quantity','porc_iva','iva','porc_otro_impuesto','otro_impuesto','porc_impoconsumo','impoconsumo','total'];
